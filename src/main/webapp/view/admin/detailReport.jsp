...
<form method="post" action="updateReport">
    ...
    <div class="title">
        <div class="left">
            ...
            <h1><a href="ViewUserForAdmin?userID=${report.getUserReport().getID()}">${report.getUserReport().getName()}</a></h1>
        </div>
        <i class="fas fa-arrow-right"></i>
        <div class="right">
            <img src="${report.getUserViolate().getAvatar()}" alt="">
            <h1><a href="ViewUserForAdmin?userID=${report.getUserViolate().getID()}">${report.getUserViolate().getName()}</a></h1>
        </div>
    </div>
